{
  ...
  officialRelease ? {
    version = "15.0.2";
    sha256 = "sha256-eGvRLlW8mH2KxVvEzauuO+askfB+WqNsqL5x5rPT1Es=";
  },
  # i.e.:
  # {
  #   version = /* i.e. "15.0.0" */;
...
in let
  ...
  tools = lib.makeExtensible (tools: let
    callPackage = newScope (tools // {inherit stdenv cmake ninja libxml2 python3 isl release_version version packageVendor monorepoSrc buildLlvmTools;});
  ...
  libraries = lib.makeExtensible (libraries: let
    callPackage = newScope (libraries // buildLlvmTools // {inherit stdenv cmake ninja libxml2 python3 isl release_version version monorepoSrc packageVendor;});
  in {
