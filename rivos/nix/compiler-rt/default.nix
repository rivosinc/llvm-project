...
in
  stdenv.mkDerivation {
    ...
    nativeBuildInputs =
      [cmake ninja python3 libllvm.dev]
      ++ lib.optional stdenv.isDarwin xcbuild.xcrun;
    buildInputs = [linuxHeaders] ++ lib.optional stdenv.hostPlatform.isDarwin libcxxabi;
    ...
    cmakeFlags =
      ...
      ++ lib.optionals (haveLibc && stdenv.hostPlatform.libc == "glibc") [
        "-DSANITIZER_COMMON_CFLAGS=-I${libxcrypt-headers}/include"
      ]
      ...
      ++ lib.optionals (useLLVM || bareMetal || builtinsOnly) [
        "-DCOMPILER_RT_BUILD_PROFILE=OFF"
      ]
      ...
      ++ lib.optionals ((useLLVM && !haveLibc) || builtinsOnly) [
        "-DCMAKE_C_FLAGS=-nodefaultlibs"
      ]
      ++ lib.optionals (useLLVM || builtinsOnly) [
    ...
    postPatch =
      ...
      ''
      # TODO: get this working upstream for arches other than riscv.
