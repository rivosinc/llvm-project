{
  ...
  isainfo_cpp = lib.readFile ../../../llvm/lib/Support/RISCVISAInfo.cpp;
  needsRiscvUnrecognizedExtPatch = !(lib.hasInfix "RISCVISAInfo::parseNormalizedArchString" isainfo_cpp);
in
  stdenv.mkDerivation (rec {
      ...
      patches =
        ...
        ++ lib.optionals needsRiscvUnrecognizedExtPatch [./permit-unrecognized-riscv-extensions.patch];
      ...
      # RIVOS: don't check on vmware machines
      doCheck = false;
